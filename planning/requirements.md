...
| R10.3 | Encrypted notes excluded from search by default; content never exposed. `--encrypted` flag for searching inside encrypted notes is **pending** — requirements under review |
